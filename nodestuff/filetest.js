...
fs.readFile(filename, 'utf8', function(err, data) {
    ...
    processDataForMotion(relevant_data);
});


// -------------------------------------------------
function processDataForMotion(data) {
...
// -------------------------------------------------
function processDataForVelocity() {
    ...
    fs.readFile(processed_file_name, 'utf8', function(err, data) {
        ...
        // first observation
        var first = relevant_data.pop();

        var last_time = first[time_column];
        ...
        relevant_data.forEach(function(row) {
            ...
            var time_diff = row[time_column] - last_time;  // this is ms
